...
public class SwerveModule {
  ...
  public double getSpeedMetersPerSecond() {
    return (m_driveMotor.getVelocity().getValue() * Constants.DRIVETRAIN_ROTATIONS_TO_METERS);
  }
  /**
  ...
  public double getDriveDistanceMeters() {
    return (m_driveMotor.getPosition().getValue() * Constants.DRIVETRAIN_ROTATIONS_TO_METERS);
  }
  /**Don't use */
  public void stop() {
